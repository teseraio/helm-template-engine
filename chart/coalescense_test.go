...
func withDeps(c *Chart, deps ...*Chart) *Chart {
...
func TestCoalesceValues(t *testing.T) {
	...
	c := withDeps(&Chart{
		...
		withDeps(&Chart{
			Metadata: &Metadata{Name: "pequod"},
			Values:   map[string]interface{}{"name": "pequod", "scope": "pequod"},
		},
			&Chart{
				Metadata: &Metadata{Name: "ahab"},
				Values: map[string]interface{}{
		...
		&Chart{
			Metadata: &Metadata{Name: "spouter"},
